...
import gbFlag from "../../../public/unite-flag.png";
import esFlag from "../../../public/spain-flag.png";
...
const LangSwitcher: React.FC = () => {
  ...
  const options: Option[] = [
    { country: "English", code: "en", flag: gbFlag.src },
    { country: "Spanish", code: "es", flag: esFlag.src },
  ];
      ...
      <Box position="relative">
        ...
        >
          {options.map((option, index) => (
            ...
            >
              <ListItemIcon>
                <img src={option.flag} width={20} height={20} alt={`${option.country} flag`} />
              </ListItemIcon>
